...
def train(generator, discriminator, train_dataloader, val_dataloader, num_epochs, device):
    ...
    optimizer_G = optim.Adam(generator.parameters(), lr=0.0001, betas=(0.5, 0.999))         # was 0.0002
    optimizer_D = optim.Adam(discriminator.parameters(), lr=0.0001, betas=(0.5, 0.999))     # was 0.0002
